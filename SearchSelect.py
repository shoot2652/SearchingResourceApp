...
# Form implementation generated from reading ui file 'search reaource select.ui'
#
...
"background-repeat: none;")
        ...
        self.linfo_1 = QtWidgets.QLabel(self.centralwidget)
        self.linfo_1.setGeometry(QtCore.QRect(270, 650, 251, 41))
        self.linfo_1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.linfo_1.setObjectName("linfo_1")
        self.linfo_2 = QtWidgets.QLabel(self.centralwidget)
        self.linfo_2.setGeometry(QtCore.QRect(570, 650, 251, 41))
        self.linfo_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.linfo_2.setObjectName("linfo_2")
        self.linfo_3 = QtWidgets.QLabel(self.centralwidget)
        self.linfo_3.setGeometry(QtCore.QRect(870, 650, 251, 41))
        self.linfo_3.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.linfo_3.setObjectName("linfo_3")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnCat1.setText(_translate("MainWindow", "PushButton"))
        self.btnCat2.setText(_translate("MainWindow", "PushButton"))
        self.btnCat3.setText(_translate("MainWindow", "PushButton"))
        self.btnCat4.setText(_translate("MainWindow", "PushButton"))
        self.btnCat7.setText(_translate("MainWindow", "PushButton"))
        self.btnCat5.setText(_translate("MainWindow", "PushButton"))
        self.btnCat8.setText(_translate("MainWindow", "PushButton"))
        self.btnCat6.setText(_translate("MainWindow", "PushButton"))
        self.btnCat11.setText(_translate("MainWindow", "PushButton"))
        self.btnCat13.setText(_translate("MainWindow", "PushButton"))
        self.btnCat9.setText(_translate("MainWindow", "PushButton"))
        self.btnCat14.setText(_translate("MainWindow", "PushButton"))
        self.btnCat12.setText(_translate("MainWindow", "PushButton"))
        self.btnCat16.setText(_translate("MainWindow", "PushButton"))
        self.btnCat15.setText(_translate("MainWindow", "PushButton"))
        self.btnCat10.setText(_translate("MainWindow", "PushButton"))
        self.linfo_1.setText(_translate("MainWindow", "change"))
        self.linfo_2.setText(_translate("MainWindow", "change"))
        self.linfo_3.setText(_translate("MainWindow", "change"))
